...
//You need to change these to template classes and implement the functions for these classes
    ...
    {
    public:
        node_iterator(coen79_lab8::node<Item>* initial = NULL) { current = initial; }
        Item& operator *( ) const { return current->data(); }       // Dereference, gets value of current
...
class const_node_iterator
    ...
    {
    public:
        const_node_iterator(const coen79_lab8::node<Item>* initial = NULL) { current = initial; }
        const Item& operator *( ) const { return current->data(); }       // Dereference, gets value of current
        ...
        bool operator ==(const_node_iterator other) const { return current == other.current; }
        bool operator !=(const_node_iterator other) const {return current != other.current; }
    private:
